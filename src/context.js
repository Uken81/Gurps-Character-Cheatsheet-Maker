...
export const ComponentRefContext = createContext(null);
export const UserContext = createContext(null);
export const SelectInputValueContext = createContext(null);
export const CharacterNameContext = createContext(null);
export const IsChoosingAdvantagesContext = createContext(null);
